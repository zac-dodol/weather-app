<template>
  <section>
    ...
    <div
      v-if="weather.hourData && weather.fiveDayData"
      class="content fullheight centerpage"
      id="content"
    >
      ...
      <div class="days">
        ...
        >
          <span class="temperature-value"
            >{{ day.Temperature.Maximum.Value }}°C</span
          >
          <span class="day-date">{{
  ...
  methods: {
    ...
    checkLocation() {
      if (
        ...
        this.weather.hourData.Link.search(this.location.locationKey) == -1
      ) {
        this.weather.hourData = null;
    ...
    error() {
      ...
      !this.location.locationKey && !this.location.locationName
        ? this.getIpAddress(true)
        : this.checkLocation();
    },
  },
